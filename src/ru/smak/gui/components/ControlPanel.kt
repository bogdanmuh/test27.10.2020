...
class ControlPanel : JPanel(){
    ...
    companion object{// static  как в с шарп
        private val MIN_SZ = GroupLayout.PREFERRED_SIZE // для примера если это будет лейбол то займет все значение
        private val MAX_SZ = GroupLayout.DEFAULT_SIZE // не больше чем обозначеная размер
                //для все окошек панелей  , константы для всех обьектов
    }
    ...
    init{
        ...
        gl.setHorizontalGroup(// размещение  спигеров и label
